...
$CURRENT_TOOLNAME = "script_panel"
$CURRENT_TOOLNAME_RAW = "script-panel"
...
# Find instances of script_panel in files and replace them with the new tool name
...
Foreach-Object {
    ...
    ((Get-Content -path $_.FullName -Raw) -replace "script_panel", $NEW_TOOLNAME_CLEAN) | Set-Content -Path $_.FullName
